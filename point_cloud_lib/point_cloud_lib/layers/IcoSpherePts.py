...
### Code from https://yaweiliu.github.io/research_notes/notes/20210301_Creating%20an%20icosphere%20with%20Python.html
...
def create_pts_icosphere(subdiv, return_faces = False):
