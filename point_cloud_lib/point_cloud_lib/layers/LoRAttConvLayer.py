...
class LoRAttConvLayer(IConvLayer):
    ...
    def __init__(self,
        ...
        # Super class init.
        super(LoRAttConvLayer, self).__init__(
        ...
        self.value_size_ = p_in_features#//2
        ...
        self.conv_weights_ = torch.nn.Parameter(
            torch.empty(
                ...
                self.value_size_,
                p_out_features))
        stdv = math.sqrt(1.0 / (self.value_size_*p_num_basis))
    ...
    def __compute_convolution__(self,
        ...
        conv_results_att = torch.einsum('nkhi,nkhi->nhi',
        ...
        conv_results_att = self.w_out_(conv_results_att)

        # Standard convolution.
        conv_results_w = torch.einsum('nki,kio->no', agg_v, self.conv_weights_)
        
        return (conv_results_att + conv_results_w)*self.norm_num_neighs_ 


class LoRAttConvLayerFactory(IConvLayerFactory):
    ...
    def __init__(self,
        ...
        # Super class init.
        super(LoRAttConvLayerFactory, self).__init__(p_dims)
