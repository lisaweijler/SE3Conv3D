...
# This script is taken from https://github.com/HavenFeng/ArtEq/blob/726287fcba0b8a1306b4370ec91661e236eb1909/src/geometry.py
...
def get_body_model(model_type, gender, batch_size, device="cpu", ext="pkl"):
    ...
    body_model_path = f"/caa/Homes01/lweijler/phd/point_clouds/point_clouds_nn/data_sets/dfaust/src_data/dfaust_data/{model_type}_model/{mtype}_{gender}.{ext}"
