...
def validation(p_model_dict, p_model, p_data_loader, p_accum_logits):
...
if __name__ == "__main__":
    ...
    model_paths = [
        "path to your model dir/model_epoch_149.pth",
    ]
    ...
    for m_path in model_paths:
        ...
        for cur_epoch in range(test_dict["num_epochs"]):
            ...
            validation(
                model_dict, models[cur_epoch % len(models)], testdl, accum_logits
            )
        ...
        if dataset_dict["dataset"] == "dfaust":
            ...
            save_results(exp_results_folder, per_class_acc, per_class_iou, mIoU, mAcc)
