    ...
    with torch.no_grad():
        ...
        for cur_iter, cur_batch in enumerate(p_data_loader):
            ...
            if cur_iter == 0:
                ...
                log_images["val_point_cloud_pred"] = wandb.Object3D(point_cloud_pred)
                ...
                if not GT_PLOTTED:
                    ...
                    log_images["val_point_cloud_gt"] = wandb.Object3D(point_cloud_gt)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--conf_file",
        default="confs/dfaust/dfaust_I_rot_pca_2F.yaml",
    ...
    # prepare model_dicts (bit awkward but does the job)
